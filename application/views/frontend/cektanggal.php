			...
			<div class="modal-body">
				<div class="table-responsive">
					<ol class="ordered-list" align="left"><span class="center_content2">
							<li>Cari tiket kemudian klik pada tombol <b>Pesan</b>&nbsp;pada tiket yang ingin Anda pesan.</li>
							...
							<li style="font-weight: normal;">Apabila telah melakukan pembayaran, bawalah bukti pembayaran pada saat keberangkatan dan dilakukan penukaran satu jam sebelum keberangkatan. </li>
						</span></ol>
