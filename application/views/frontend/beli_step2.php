			...
			<div class="row">
				...
				<div class="col-lg-5">
					...
					<div class="card mb-5">
						...
						<div class="card-body">
							<div class='form-group'>
								<div class='col-sm-12'>
									<input name='no_ktp' required="" maxlength='64' class='form-control required' placeholder='Nomor KTP' type='text' title='Nomor ktp harus diisi.' value="<?php echo $this->session->userdata('ktp') ?>">
								</div>
							</div>
							<div class='form-group'>
								<div class='col-sm-12'>
									<input name='nama_pemesan' required="" maxlength='64' class='form-control required' placeholder='Nama Pemesan' type='text' title='Nama Pemesan harus diisi.' value="<?php echo $this->session->userdata('nama_lengkap') ?>">
								</div>
							</div>
							<div class='form-group'>
								<div class='col-sm-12'>
									<input name='hp' required="" maxlength='16' class='form-control required' placeholder='Handphone' type='text' title='Handphone harus diisi.' value="<?php echo $this->session->userdata('telpon') ?>">
								</div>
							</div>
							<div class='form-group'>
								<div class='col-sm-12'>
									<textarea name='alamat' cols='20' rows='3' id='alamat' required="" maxlength='256' class='form-control required' placeholder='Alamat' title='Alamat harus diisi.'><?php echo $this->session->userdata('alamat') ?></textarea>
								</div>
							</div>
							<div class='form-group'>
								<div class='col-sm-12'>
				...
				<div class="col">
					<div class="card">
						...
						<div class="card-body">
							<form action="<?php echo base_url() ?>tiket/chekout" method="post">
								<div class="form-group">
