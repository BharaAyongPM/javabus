...
<body>
	<!-- navbar -->
	<?php $this->load->view('frontend/header'); ?><section class="service-area section-gap relative">
							...
							<div class="table-responsive">
								<table class="table table-striped">
									...
									<tbody>
										...
										<?php } ?>
										<td colspan="5"> <b class="pull-right">Total Rp <?php $total = $count * $tiket[0]['harga_jadwal'];
																																		echo $total ?></b></td>
									</tbody>
								</table>
							</div>
				...
				<div class="col-lg-8">
					...
					<div class="card">
						...
						<div class="card-body" align="center">
							...
							<p>(Sebelum <?php $expired = hari_indo(date('N', strtotime($tiket[0]['expired_order']))) . ', ' . tanggal_indo(date('Y-m-d', strtotime('' . $tiket[0]['expired_order'] . ''))) . ', ' . date('H:i', strtotime($tiket[0]['expired_order']));
													echo $expired; ?>)</p>
							<hr>
							...
							<div class="offset-lg-1 col-lg-10 offset-sm-0 col-sm-12">
								<div class="row">
									...
									<div class="col-md-6 col-8 mb-xs-10 rekening-text">
										<p><input type="hidden" name="" id="myInput" value="<?php echo $tiket[0]['nomrek_bank']; ?> an <?php echo $tiket[0]['nama_bank'] ?>">
										<h4 id="myInput"><?php echo number_format((float)($tiket[0]['nomrek_bank']), 0, "-", "-"); ?> an <?php echo $tiket[0]['nama_bank'] ?></h4>
										</p>
									</div>
