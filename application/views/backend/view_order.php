...
<body id="page-top">
	...
	<div class="container-fluid">
		<!-- Page Heading -->
		<h1 class="h3 mb-4 text-gray-800">Info Order</h1>
		<!-- Basic Card Example -->
							...
							<div class="col-sm-6">
								<div class="row form-group">
									...
									<div class="col-sm-8">
										...
										<?php } elseif ($tiket[0]['status_order'] == '2') { ?><p class="btn "><b class="btn btn-default">Sudah Bayar</b>
								...
								<div class="row form-group">
									...
									<div class="col-sm-8">
										<p><b>Rp <?php $total =  count($tiket) * $tiket[0]['harga_jadwal'];
