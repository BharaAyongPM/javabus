		...
		<div class="card shadow mb-4">
			...
			<div class="card-body">
				<div class="card-body">
					...
					<a href="<?= base_url('jadwal/hapusjadwal/') . $jadwal['kd_jadwal']; ?>" onclick="return confirm('Kamu yakin akan menghapus <?= $jadwal['kd_jadwal']; ?> ?');" class="badge badge-danger"><i class="fas fa-trash"></i> Hapus</a>
			...
			<form action="<?php echo base_url(); ?>jadwal/hapusjadwal" method="post" enctype="multipart/form-data" <div class="modal-content">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="exampleModalLabel">yakin mau menghapus jadwal?</h5>
						<input type="hidden" name="kd_jadwal" required="" value="<?php echo $jadwal['kd_jadwal']; ?>">
